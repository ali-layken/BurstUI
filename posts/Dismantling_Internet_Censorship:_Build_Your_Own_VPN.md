...
If there are no networks near you that you can trust, an amazing way to rethink this guide is to start imagining your allies and thinking about who *you* can trust. We are halfway through explaining the DNS system, which is easier to explain using enemies. The aforementioned [finalejump](#whats-next-sunriseovermountains) about the potential future is much easier explained using allies, so start thinking about it :brain:
