...
In the Xsource's `::update` function, called when the application wants a new frame from the source, I read the running gstreamer pipeline and copied the pixels to the texture that I've registered as my source:
```cpp
